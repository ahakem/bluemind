...
const About = ({ showFullContent = false, showCTA = true }: AboutProps) => {
  return (
    <Box 
      component="section" 
      id="about" 
      ...
      <Container maxWidth="lg">
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Box sx={{ position: 'relative', width: '100%', aspectRatio: '4/3', borderRadius: 2, overflow: 'hidden' }}>
              <Image
                src="/images/BMF-founders.webp"
                alt="Hakim and Dewi - Founders of Blue Mind Freediving Amsterdam, AIDA certified freediving instructors"
                fill
