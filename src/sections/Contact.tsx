  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        ...
        >
          <iframe
            src="https://maps.google.com/maps?q=52.370227,4.817489&hl=en&z=16&output=embed"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
            ...
            title="Blue Mind Freediving training location - Sloterparkbad, President Allendelaan 3, 1064 GW Amsterdam"
          />
          
          {/* Custom Marker Overlay with Favicon */}
          <Box
            sx={{
              position: 'absolute',
              top: '50%',
