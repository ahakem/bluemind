...
export const countryByLabel: Record<string, CountryType> = Object.fromEntries(
  countries.map((c) => [c.label.toLowerCase(), c])
);

export function lookupCountry(name: string): CountryType | undefined {
  return countryByLabel[name.toLowerCase()];
}
