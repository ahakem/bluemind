...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  try {
    ...
    // Prefer saved authorDisplayName, fall back to fetching
    let authorDisplayName = post.authorDisplayName || 'BlueMind';
      ...
      <Container maxWidth="md" sx={{ py: 8 }}>
        ...
        <Box
          sx={{
            ...
            // Hide empty paragraphs generated by React Quill
